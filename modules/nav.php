      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target=".navbar-collapse">
            ...
            <a class="navbar-brand" href="/websterfamily.co/index.php">Webster Family Blog</a>
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
              
              <li><a href="/websterfamily.co/index.php">Home</a></li>
...
<!--                <li class="dropdown-header">Nav header</li>
          ...
          <ul class="nav navbar-nav navbar-right">
            <!--<li><a href="/websterfamily.co/account">Default</a></li>-->
            <li><a href="/websterfamily.co/accounts/index.php">My Account</a></li>
